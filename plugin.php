...
class BlackWebsiteSetting {
    ...
    public function blackwebsite_right_bottom_callback()
    {
        printf(
            ...
            isset( $this->predefineOption['blackwebsite_right_bottom'] ) ? esc_attr( $this->options['blackwebsite_right_bottom']) : ''
        );
    }
...
function blackwebsite_position(){
    ...
    $blackwebsite_bottom = "32px";
    $blackwebsite_left = "unset";
    $blackwebsite_right = "32px";
    $blackwebsite_time = "false";

    //Extra options
    if ($blackwebsite_extra_options['blackwebsite_cookies'] == 1){
    ...
    if (isset($blackwebsite_extra_options['blackwebsite_toggle']) == 1){
        ...
        // $blackwebsite_toggle .= "<button class='darkmode-enable'>Toggle</button>";
        // }
    }else{
        $blackwebsite_toggle = "const darkmode = new Darkmode(options); darkmode.showWidget();";
    }
    ...
    if ($blackwebsite_predefine_options['blackwebsite_left_bottom'] == '1'){
        require_once BLACKWEBSITE_DIR_PATH .'inc/button-position/left-button.php';
    }elseif ($blackwebsite_predefine_options['blackwebsite_right_bottom'] == '1'){
